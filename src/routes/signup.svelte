<script>
    ...
    async function signUp() {
        const {user, session: authsession, error} = await supabase.auth.signUp({
            email, password
        })
...
<div class="auth-page">
    <div class="auth-card ">
        <div class="auth-grid">
            ...
            <form class="auth-card-title" on:submit|preventDefault={signUp}>
            ...
            <div class="input-button">
                <a class="btn w-full" href="/signin">Already Registered?</a>
            </div>
            <div class="input-button">
