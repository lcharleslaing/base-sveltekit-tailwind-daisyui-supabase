...
var require_package = __commonJS({
  "node_modules/websocket/package.json"(exports, module2) {
    module2.exports = {
      ...
      _where: "B:\\Users\\lchar\\WebstormProjects\\sveltekit-supabase-blog\\node_modules\\@supabase\\realtime-js",
      author: {
        name: "Brian McKelvey",
...
var require_SupabaseClient = __commonJS({
  "node_modules/@supabase/supabase-js/dist/main/SupabaseClient.js"(exports) {
    ...
    var SupabaseClient = class {
      ...
      _initSupabaseAuthClient({ autoRefreshToken, persistSession, detectSessionInUrl, localStorage: localStorage2, headers }) {
        const authHeaders = {
...
var require_ordered_uuid = __commonJS({
  "node_modules/ordered-uuid/index.js"(exports, module2) {
    init_shims();
    "use strict";
...
async function render_endpoint(request, route, match) {
  ...
  if (typeof response !== "object") {
    return error$3(`${preface}: expected an object, got ${typeof response}`);
  }
  ...
  if (!is_type_textual && !(body instanceof Uint8Array || is_string(body))) {
    return error$3(`${preface}: body must be an instance of string or Uint8Array if content-type is not a supported textual content-type`);
  }
  let normalized_body;
...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n  <head>\n    <meta charset="utf-8" />\n    <link rel="icon" href="/favicon.png" />\n    <script\n      src="https://kit.fontawesome.com/b4ac6ef2b3.js"\n      crossorigin="anonymous"\n    ><\/script>\n    <link rel="stylesheet" href="app.css" />\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\n    ' + head + '\n  </head>\n  <body>\n    <div id="svelte">' + body + "</div>\n  </body>\n</html>\n";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-b7263374.js",
      css: [assets + "/_app/assets/start-464e9d0a.css"],
      js: [assets + "/_app/start-b7263374.js", assets + "/_app/chunks/vendor-c7965793.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "b2t-logo.svg", "size": 8532, "type": "image/svg+xml" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/magic\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/magic.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
    ...
    },
    {
      ...
      pattern: /^\/open\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/open.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/magic.svelte": () => Promise.resolve().then(function() {
    return magic;
  }),
  "src/routes/auth.svelte": () => Promise.resolve().then(function() {
    return auth;
  }),
  "src/routes/open.svelte": () => Promise.resolve().then(function() {
    return open;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-96a8d0a1.js", "css": ["assets/pages/__layout.svelte-0dd47a27.css"], "js": ["pages/__layout.svelte-96a8d0a1.js", "chunks/vendor-c7965793.js", "chunks/db-311bf7c7.js", "chunks/stores-a9388af6.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-376c5fc1.js", "css": [], "js": ["error.svelte-376c5fc1.js", "chunks/vendor-c7965793.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-b8836e3d.js", "css": [], "js": ["pages/index.svelte-b8836e3d.js", "chunks/vendor-c7965793.js", "chunks/db-311bf7c7.js"], "styles": [] }, "src/routes/portfolio.svelte": { "entry": "pages/portfolio.svelte-29732452.js", "css": [], "js": ["pages/portfolio.svelte-29732452.js", "chunks/vendor-c7965793.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-cbf2451a.js", "css": [], "js": ["pages/contact.svelte-cbf2451a.js", "chunks/vendor-c7965793.js"], "styles": [] }, "src/routes/signin.svelte": { "entry": "pages/signin.svelte-0fd39921.js", "css": [], "js": ["pages/signin.svelte-0fd39921.js", "chunks/vendor-c7965793.js", "chunks/db-311bf7c7.js", "chunks/stores-a9388af6.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/signup.svelte": { "entry": "pages/signup.svelte-8d0899e7.js", "css": [], "js": ["pages/signup.svelte-8d0899e7.js", "chunks/vendor-c7965793.js", "chunks/db-311bf7c7.js", "chunks/stores-a9388af6.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-00356f10.js", "css": [], "js": ["pages/about.svelte-00356f10.js", "chunks/vendor-c7965793.js"], "styles": [] }, "src/routes/magic.svelte": { "entry": "pages/magic.svelte-12c6a9dc.js", "css": [], "js": ["pages/magic.svelte-12c6a9dc.js", "chunks/vendor-c7965793.js", "chunks/db-311bf7c7.js", "chunks/stores-a9388af6.js"], "styles": [] }, "src/routes/auth.svelte": { "entry": "pages/auth.svelte-2fb604eb.js", "css": [], "js": ["pages/auth.svelte-2fb604eb.js", "chunks/vendor-c7965793.js", "chunks/db-311bf7c7.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/open.svelte": { "entry": "pages/open.svelte-47265c08.js", "css": [], "js": ["pages/open.svelte-47265c08.js", "chunks/vendor-c7965793.js"], "styles": [] } };
...
(0, import_supabase_js.createClient)("https://jjtiwfpllawrqpqskody.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzMzk2MDcyNiwiZXhwIjoxOTQ5NTM2NzI2fQ.WI1vN0ezoY71cZ82coO7HcFVamcgHQbH3Otb1DxrYpw");
var getStores = () => {
...
var session = {
  ...
  set: () => error$2("set"),
  update: () => error$2("update")
};
var css = {
  code: "svg.svelte-1480cdo{cursor:pointer}",
  map: '{"version":3,"file":"Menu.svelte","sources":["Menu.svelte"],"sourcesContent":["<svg\\r\\n  xmlns=\\"http://www.w3.org/2000/svg\\"\\r\\n  class=\\"mr-4 h-8 w-8\\"\\r\\n  fill=\\"none\\"\\r\\n  viewBox=\\"0 0 24 24\\"\\r\\n  stroke=\\"currentColor\\"\\r\\n>\\r\\n  <path\\r\\n    stroke-linecap=\\"round\\"\\r\\n    stroke-linejoin=\\"round\\"\\r\\n    stroke-width=\\"2\\"\\r\\n    d=\\"M4 6h16M4 12h16M4 18h16\\"\\r\\n  />\\r\\n</svg>\\r\\n\\r\\n<style>svg{cursor:pointer}</style>\\r\\n"],"names":[],"mappings":"AAeO,kBAAG,CAAC,OAAO,OAAO,CAAC"}'
};
var Menu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"mr-4 h-8 w-8 svelte-1480cdo"}" fill="${"none"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M4 6h16M4 12h16M4 18h16"}"></path></svg>`;
});
var Navbar2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"navbar justify-evenly shadow-xl"}">${validate_component(Menu, "Menu").$$render($$result, {}, {}, {})}
  <div class="${"logo-brand"}"><div class="${"logo"}"><img src="${"b2t-logo.svg"}" alt="${""}" class="${""}"></div>
    <div class="${"brand"}">BIG2TINY</div></div>
  <div class="${"flex items-center"}"><a href="${"."}" class="${"link"}">Home</a>
    <a href="${"/about"}" class="${"link"}">About</a>
    <a href="${"/portfolio"}" class="${"link"}">Portfolio</a>
    <a href="${"/contact"}" class="${"link"}">Contact</a></div>
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_session();
  return `${validate_component(Navbar2, "Navbar2").$$render($$result, {}, {}, {})}
<div class="${"bg-gray-200 h-screen"}">${slots.default ? slots.default({}) : ``}
</div>`;
});
  ...
  (function(f) {
    ...
    return function e(t, n, r) {
      ...
      for (var o = 0; o < r.length; o++)
        s2(r[o]);
      return s2;
    }({ 1: [function(_dereq_, module22, exports2) {
      (function(global2) {
      ...
      }).call(this, typeof commonjsGlobal2 !== "undefined" ? commonjsGlobal2 : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
    }, {}], 2: [function(_dereq_, module22, exports2) {
    ...
    }, { "1": 1 }], 3: [function(_dereq_, module22, exports2) {
      (function(global2) {
        if (typeof global2.Promise !== "function") {
          global2.Promise = _dereq_(2);
        }
      }).call(this, typeof commonjsGlobal2 !== "undefined" ? commonjsGlobal2 : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
    }, { "2": 2 }], 4: [function(_dereq_, module22, exports2) {
...
function get(options2 = { keys: false }) {
  this.getCollection = () => {
    ...
    return this.lf[collectionName].iterate((value, key) => {
      ...
      logMessage += `:`;
      logger.log.call(this, logMessage, collection2);
      reset.call(this);
      return collection2;
    });
  };
  this.getDocument = () => {
    ...
    this.getDocumentByCriteria = () => {
      return this.lf[collectionName].iterate((value, key) => {
        ...
        if (!collection2.length) {
          ...
          document2 = collection2[0];
          logger.log.call(this, `Got Document with ${JSON.stringify(docSelectionCriteria)}:`, document2);
          reset.call(this);
          return document2;
        }
      });
    ...
    this.getDocumentByKey = () => {
      return this.lf[collectionName].getItem(docSelectionCriteria).then((value) => {
        document2 = value;
        if (document2) {
          logger.log.call(this, `Got Document with key ${JSON.stringify(docSelectionCriteria)}:`, document2);
        } else {
  ...
  if (!(typeof options2 == "object" && options2 instanceof Array == false)) {
    ...
    if (!options2.hasOwnProperty("keys")) {
      ...
      if (typeof options2.keys !== "boolean") {
  ...
  if (!this.userErrors.length) {
    ...
    return new Promise((resolve2, reject) => {
      ...
      return this.lf[collectionName].setItem(key, data).then(() => {
        resolve2(success.call(this, `Document added to "${collectionName}" collection.`, { key, data }));
      }).catch((err) => {
  ...
  return new Promise((resolve2, reject) => {
    this.updateDocumentByCriteria = () => {
      ...
      this.lf[collectionName].iterate((value, key) => {
        ...
        docsToUpdate.forEach((docToUpdate, index2) => {
          this.lf[collectionName].setItem(docToUpdate.key, docToUpdate.newDocument).then((value) => {
            if (index2 === docsToUpdate.length - 1) {
              resolve2(success.call(this, `${docsToUpdate.length} Document${docsToUpdate.length > 1 ? "s" : ""} in "${collectionName}" collection with ${JSON.stringify(docSelectionCriteria)} updated.`, docUpdates));
            }
          }).catch((err) => {
    ...
    this.updateDocumentByKey = () => {
      ...
      this.lf[collectionName].getItem(docSelectionCriteria).then((value) => {
        ...
        resolve2(success.call(this, `Document in "${collectionName}" collection with key ${JSON.stringify(docSelectionCriteria)} updated.`, newDocument));
      }).catch((err) => {
...
function set(newDocument, options2 = { keys: false }) {
  let collectionName = this.collectionName;
  let docSelectionCriteria = this.docSelectionCriteria;
  let currentSelectionLevel = selectionLevel.call(this);
  return new Promise((resolve2, reject) => {
    this.setCollection = () => {
      this.lf[collectionName].clear().then(() => {
        if (!options2.keys) {
          ...
          resolve2(success.call(this, `Collection "${collectionName}" set with ${newDocument.length} Documents.`, newDocument));
        } else {
    ...
    this.setDocument = () => {
      this.setDocumentByCriteria = () => {
        ...
        this.lf[collectionName].iterate((value, key) => {
          ...
          docsToSet.forEach((docToSet, index2) => {
            this.lf[collectionName].setItem(docToSet.key, docToSet.newDocument).then((value) => {
              if (index2 === docsToSet.length - 1) {
                resolve2(success.call(this, `${docsToSet.length} Document${docsToSet.length > 1 ? "s" : ""} in "${collectionName}" collection with ${JSON.stringify(docSelectionCriteria)} was set.`, newDocument));
              }
            }).catch((err) => {
      ...
      this.setDocumentByKey = () => {
        this.lf[collectionName].setItem(docSelectionCriteria, newDocument).then((value) => {
          resolve2(success.call(this, `Document in "${collectionName}" collection with key ${JSON.stringify(docSelectionCriteria)} was set.`, newDocument));
        }).catch((err) => {
...
function deleteIt() {
  return new Promise((resolve2, reject) => {
    this.deleteDatabase = () => {
      ...
      resolve2(success.call(this, `Database "${dbName}" deleted.`, { database: dbName }));
    };
      ...
      this.deleteNextCollectionFromQueue = () => {
        if (this.deleteCollectionQueue.queue.length) {
          ...
          this.lf[collectionToDelete].dropInstance({
            ...
            this.deleteNextCollectionFromQueue();
            resolve2(success.call(this, `Collection "${collectionToDelete}" deleted.`, { collection: collectionToDelete }));
          }).catch((error2) => {
            reject(error2.call(this, `Collection "${collectionToDelete}" could not be deleted.`));
          });
        } else {
    ...
    this.deleteDocument = () => {
      ...
      this.deleteDocumentByCriteria = () => {
        ...
        this.lf[collectionName].iterate((value, key) => {
          ...
          keysForDeletion.forEach((key, index2) => {
            this.lf[collectionName].removeItem(key).then(() => {
              if (index2 === keysForDeletion.length - 1) {
                resolve2(success.call(this, `${keysForDeletion.length} Document${keysForDeletion.length > 1 ? "s" : ""} with ${JSON.stringify(docSelectionCriteria)} deleted.`, { keys: keysForDeletion }));
              }
            }).catch((err) => {
        ...
        this.lf[collectionName].getItem(docSelectionCriteria).then((value) => {
          if (value) {
            this.lf[collectionName].removeItem(docSelectionCriteria).then(() => {
              resolve2(success.call(this, `Document with key ${JSON.stringify(docSelectionCriteria)} deleted.`, { key: docSelectionCriteria }));
            }).catch(function(err) {
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  new Localbase("db");
  return `<div class="${"container"}"><h1 class="${"text-center"}">Home Page</h1>
</div>`;
});
...
var Portfolio = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"text-center"}">Portfolio</div>`;
});
...
var Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"text-center"}">Contact</div>`;
});
...
var Signin = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let email, password;
  $$unsubscribe_session();
  return `<div class="${"auth-page"}"><div class="${"auth-card "}"><div class="${"auth-grid"}"><div class="${"auth-card-title"}">Sign In</div>
      <form class="${"auth-card-title"}"><div class="${"input-button"}"><input type="${"email"}" placeholder="${"Email..."}" class="${"bg-gray-200 text-gray-700 input w-full"}"${add_attribute("value", email, 0)}></div>
        <div class="${"input-button my-2"}"><input type="${"password"}" placeholder="${"Password..."}" class="${"bg-gray-200 text-gray-700 input w-full"}"${add_attribute("value", password, 0)}></div>
        <div class="${"input-button"}"><button class="${"btn w-full"}">Sign In</button></div></form>
      <div class="${"input-button"}"><a class="${"btn w-full"}" href="${"/signup"}">Not Registered?</a></div>
      <div class="${"input-button"}"><a class="${"btn w-full"}" href="${"/magic"}">Magic</a></div></div></div>
</div>`;
});
...
var Signup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let email, password;
  $$unsubscribe_session();
  return `<div class="${"auth-page"}"><div class="${"auth-card "}"><div class="${"auth-grid"}"><div class="${"auth-card-title"}">Sign Up</div>
            <form class="${"auth-card-title"}"><div class="${"input-button"}"><input type="${"email"}" placeholder="${"Email..."}" class="${"bg-gray-200 text-gray-700 input w-full"}"${add_attribute("value", email, 0)}></div>
                <div class="${"input-button my-2"}"><input type="${"password"}" placeholder="${"Password..."}" class="${"bg-gray-200 text-gray-700 input w-full"}"${add_attribute("value", password, 0)}></div>
            <div class="${"input-button"}"><button class="${"btn w-full"}">Sign Up</button></div></form>
            <div class="${"input-button"}"><a class="${"btn w-full"}" href="${"/signin"}">Already Registered?</a></div>
            <div class="${"input-button"}"><a class="${"btn w-full"}" href="${"/magic"}">Magic</a></div></div></div>
</div>`;
});
...
var About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"text-center"}">About</div>`;
});
...
var Magic = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_session;
  $$unsubscribe_session = subscribe(session, (value) => value);
  let email;
  $$unsubscribe_session();
  return `
<div class="${"auth-page"}"><div class="${"auth-card "}"><div class="${"auth-grid"}"><div class="${"auth-card-title"}">Magic Login</div>
      <form class="${"auth-card-title"}"><div class="${"input-button"}"><input type="${"email"}" placeholder="${"Email..."}" class="${"bg-gray-200 text-gray-700 input w-full"}"${add_attribute("value", email, 0)}></div>
        <div class="${"input-button my-2"}"><button class="${"btn w-full"}">Get your Magic Link</button></div></form></div></div>
</div>`;
});
var magic = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Magic
});
var Auth = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"auth-page"}"><div class="${"grid gap-4"}"><a href="${"/signup"}" class="${"btn bg-blue-900"}">Sign In with Email</a>
    <button class="${"btn bg-green-900"}">Sign In with Google</button>
    <button class="${"btn bg-red-900"}">Sign Out</button></div></div>`;
});
...
var Open = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"text-center mt-12"}"><div class="${"text-4xl text-green-700"}">PUBLIC PAGE</div>
  <div class="${"text-4xl text-red-700"}">You are NOT Signed In!</div></div>`;
});
